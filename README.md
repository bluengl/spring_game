...
└── spring_game_api/                   # 服务模块
    ├── spring_game_api_core/          # 核心业务模块
    │   ├── 数据访问层
    │   ├── 实体类
    │   ├── Mapper接口
    │   └── 通用业务逻辑
    ├── spring_game_api_base/          # 基础服务
    │   ├── 用户认证
    │   ├── 系统配置
    │   └── 基础接口
    ├── spring_game_api_game/          # 游戏服务
    │   ├── 游戏管理
    │   ├── 成绩记录
    │   └── 排行榜
    ├── spring_game_api_user/          # 用户服务
    │   ├── 用户信息
    │   ├── 用户设置
    │   └── 用户统计
    ├── spring_game_api_online/        # 在线服务
    │   ├── 在线状态
    │   ├── 会话管理
    │   └── 心跳检测
    └── spring_game_api_group/         # 群组服务
        ├── 群组管理
        ├── 成员管理
        └── 消息管理
```
